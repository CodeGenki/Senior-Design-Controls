...
// Channel A
//#define RX_ISR  PieVectTable.SCIA_RX_INT
//#define RX_ACK  PieCtrlRegs.PIEACK.bit.ACK9
//#define RX_IEN  PieCtrlRegs.PIEIER9.bit.INTx1
//volatile struct SCI_REGS *sci_ch = &SciaRegs;
...
#define FREQ_CHANGE     0X45

#define SET_FREQ        0x30
//////////////////////////////////////////////////////////////////////////
...
//    case 'a':       GpioDataRegs.GPDTOGGLE.bit.GPIO110 = 1;          break;
      ...
      case FREQ_CHANGE:   Change_Freq(arg_1);  break;
